...
from Server.core.json_commands import JsonCommands


setup_logger()


class ClientHandler(JsonCommands):
    def __init__(self, addr, Handlers, Managers):
        ...
        self.typs = {
            'private_message': self.Handlers.client_messages.private_message,
            'set_nickname': self.Handlers.client_messages.set_nickname,
            'get_users_list': self.Handlers.client_messages.return_users_list,
